...
def save_or_show(arr, filename, save=False):
    if save:
        plt.imsave('./images/results/' + filename + '_org' + '.png', arr[0])
        plt.imsave('./images/results/' + filename + '_mask' + '.png', arr[0])
        plt.imsave('./images/results/' + filename + '_fused' + '.png', arr[0])
    else:
